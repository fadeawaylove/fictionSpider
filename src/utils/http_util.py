...
class HttpClient:
    ...
    @classmethod
    async def get(cls, url, return_type="raw", **kwargs):
        """
    ...
    @classmethod
    async def post(cls, url, return_type="raw", **kwargs):
        """
    ...
    @classmethod
    async def put(cls, url, return_type="raw", **kwargs):
        return await cls._request("put", url, return_type=return_type, **kwargs)

    @classmethod
    async def delete(cls, url, return_type="raw", **kwargs):
